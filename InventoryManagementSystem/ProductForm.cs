...
namespace InventoryManagementSystem
{
    public partial class ProductForm : Form
    {
        ...
        public void LoadProduct()
        {
            ...
            cmd = new SqlCommand("SELECT * FROM tbProduct WHERE CONCAT(pid, pname, pqty, pprice, pdescription, pcategory) LIKE '%" + txtSearch.Text + "%' ", con);
            con.Open();
        ...
        private void dgvProduct_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            {
                if (MessageBox.Show("Are you sure you want to delete product", "Delete Record", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                {
                    con.Open();
